...
import com.xh229210209.newmanagemoneyapp.NewDBSQlite.MyDBOpenHelper;
...
public class IncomeActivity extends AppCompatActivity {
    ...
    private void initTimePickView() {
        //时间选择器
        mTimePicker = new TimePickerBuilder(IncomeActivity.this, new OnTimeSelectListener() {
            @Override
    ...
    private void initView() {
        ...
        mlook_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(IncomeActivity.this, "记录成功！", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(IncomeActivity.this,MainActivity.class));
            }
        });
        mhelper=new MyDBOpenHelper(IncomeActivity.this);//实例化数据库帮助类
        db=mhelper.getWritableDatabase();//创建数据库，获取数据库的读写权限
    }

    private void ShowDataTypePickerView() {
        mAlarmTypeNameOptions=new OptionsPickerBuilder(IncomeActivity.this, new OnOptionsSelectListener() {
            @Override
